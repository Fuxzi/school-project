...
<div class="max-w-6xl mx-auto px-4 py-6">
  <div class="glass-card rounded-2xl p-6">
    ...
    <p class="text-muted text-sm mt-2">
      ...
      Di sini kamu bisa melihat review, memberi rating, dan berbagi pendapat tanpa fitur e-commerce yang tidak perlu.
    </p>
  ...
  <div class="glass-card rounded-2xl p-6 mt-4">
    <h2 class="text-lg font-extrabold text-white/90">Contributors / Kelompok</h2>
    <p class="text-muted text-sm mt-2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mt-4">
      <div class="input-glass rounded-2xl p-4">
        <div class="text-white/90 font-extrabold">Fahri Ilham Muzzaki</div>
        <div class="text-white/60 text-sm mt-1">Contributor</div>
      </div>

      <div class="input-glass rounded-2xl p-4">
        <div class="text-white/90 font-extrabold">Muhamad Raihan Arifin</div>
        <div class="text-white/60 text-sm mt-1">Contributor</div>
      </div>

      <div class="input-glass rounded-2xl p-4">
        <div class="text-white/90 font-extrabold">Maulana Ilham Ramadhan/div>
        <div class="text-white/60 text-sm mt-1">Contributor</div>
      </div>
    </div>
  </div>
